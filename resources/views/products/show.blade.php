    ...
    <div class="container mx-auto px-4">
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-2 text-sm">
                ...
                <li><a href="{{ route('products.index') }}" class="text-gray-600 hover:text-primary transition">Sản phẩm</a></li>
                <li><i class="fas fa-chevron-right text-gray-400 text-xs"></i></li>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div x-data="{ currentImage: 0, images: [1,2,3,4,5] }">
                ...
                <div class="relative mb-4 rounded-lg overflow-hidden bg-gray-100">
                    ...
                    <!-- Navigation Arrows -->
                    <button @click="currentImage = currentImage > 0 ? currentImage - 1 : images.length - 1" class="absolute left-2 top-1/2 transform -translate-y-1/2 bg-white/80 hover:bg-white text-gray-800 w-10 h-10 rounded-full flex items-center justify-center transition">
                        <i class="fas fa-chevron-left"></i>
                    </button>
                    <button @click="currentImage = currentImage < images.length - 1 ? currentImage + 1 : 0" class="absolute right-2 top-1/2 transform -translate-y-1/2 bg-white/80 hover:bg-white text-gray-800 w-10 h-10 rounded-full flex items-center justify-center transition">
                ...
                <div class="grid grid-cols-5 gap-2">
                    <template x-for="(image, index) in images" :key="index">
                        ...
                        >
                            <img 
                                :src="'https://via.placeholder.com/150x150/FFFFFF/0066CC?text=Thumb+' + (index + 1)" 
                                alt="Thumbnail"
            ...
            <div>
                ...
                <div class="flex items-center space-x-4 mb-4 pb-4 border-b">
                    ...
                    <span class="text-gray-600"><strong>Thương hiệu:</strong> <a href="#" class="text-primary hover:underline">Apple</a></span>
                    <span class="text-gray-400">|</span>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-4 gap-3">
                        <button class="border-2 border-primary bg-primary/10 text-primary rounded-lg py-2 px-4 font-medium hover:bg-primary hover:text-white transition">
                            128GB
                        </button>
                        <button class="border-2 border-gray-300 rounded-lg py-2 px-4 font-medium hover:border-primary hover:text-primary transition">
                            256GB
                        </button>
                        <button class="border-2 border-gray-300 rounded-lg py-2 px-4 font-medium hover:border-primary hover:text-primary transition">
                            512GB
                ...
                <div class="mb-6">
                    ...
                    <div class="flex space-x-3">
                        ...
                        <button class="w-12 h-12 rounded-full border-2 border-gray-300 bg-black hover:border-primary transition"></button>
                        <button class="w-12 h-12 rounded-full border-2 border-gray-300 bg-blue-900 hover:border-primary transition"></button>
                        <button class="w-12 h-12 rounded-full border-2 border-gray-300 bg-white hover:border-primary transition"></button>
                    </div>
                </div>
                ...
                <div class="flex space-x-4 mb-6">
                    <button class="flex-1 btn-primary py-4 text-lg">
                ...
                <button class="w-full bg-red-500 hover:bg-red-600 text-white font-bold py-4 rounded-lg transition text-lg">
    ...
    <div class="bg-white rounded-lg shadow-md mb-8" x-data="{ activeTab: 'description' }">
        ...
        <div class="p-6">
            ...
            <div x-show="activeTab === 'description'" class="prose max-w-none">
                ...
                <p class="mb-4">iPhone 15 Pro Max là chiếc smartphone cao cấp nhất trong dòng iPhone 15 Series của Apple. Với thiết kế khung titanium sang trọng, chip A17 Pro mạnh mẽ và camera 48MP ấn tượng.</p>
                
                <h4 class="text-lg font-bold mb-2">Thiết kế đột phá với khung titanium</h4>
                <p class="mb-4">Lần đầu tiên Apple sử dụng chất liệu titanium cấp hàng không cho khung máy, mang lại độ bền cao nhưng vẫn giữ được trọng lượng nhẹ.</p>
                
                <h4 class="text-lg font-bold mb-2">Hiệu năng đỉnh cao với chip A17 Pro</h4>
                <p class="mb-4">Chip A17 Pro được sản xuất trên tiến trình 3nm tiên tiến nhất, mang lại hiệu năng vượt trội và tiết kiệm điện năng tối ưu.</p>

                <h4 class="text-lg font-bold mb-2">Camera chuyên nghiệp</h4>
                <p class="mb-4">Hệ thống camera sau 3 ống kính với cảm biến chính 48MP, hỗ trợ zoom quang học 5x và nhiều tính năng chụp ảnh chuyên nghiệp.</p>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="border-b pb-6">
                        <div class="flex items-start space-x-4">
                            <img src="https://via.placeholder.com/60x60/0066CC/FFFFFF?text=U{{ $i }}" alt="User" class="w-12 h-12 rounded-full">
                            <div class="flex-1">
                                ...
                                <p class="text-gray-700 mb-3">Sản phẩm rất tốt, đúng như mô tả. Camera chụp ảnh đẹp, pin trâu. Shop giao hàng nhanh, đóng gói cẩn thận. Mình rất hài lòng!</p>
                                <div class="flex space-x-2 mb-3">
                                    <img src="https://via.placeholder.com/100x100/FFFFFF/0066CC?text=Review" alt="Review" class="w-20 h-20 rounded-lg object-cover cursor-pointer hover:opacity-80">
                                    <img src="https://via.placeholder.com/100x100/FFFFFF/0066CC?text=Review" alt="Review" class="w-20 h-20 rounded-lg object-cover cursor-pointer hover:opacity-80">
                                    <img src="https://via.placeholder.com/100x100/FFFFFF/0066CC?text=Review" alt="Review" class="w-20 h-20 rounded-lg object-cover cursor-pointer hover:opacity-80">
                                </div>
                                <div class="flex items-center space-x-4 text-sm text-gray-600">
                                    <button class="hover:text-primary transition"><i class="far fa-thumbs-up mr-1"></i>Hữu ích ({{ rand(5, 50) }})</button>
                                    <button class="hover:text-primary transition"><i class="far fa-comment mr-1"></i>Trả lời</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
            ...
            <div class="product-card group">
                <div class="relative">
                    <img src="https://via.placeholder.com/300x300/FFFFFF/0066CC?text=Related+{{ $i }}" alt="Product" class="w-full h-48 object-cover">
                ...
                <div class="p-4">
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-primary font-bold text-lg">{{ number_format(rand(20,35) * 990000, 0, ',', '.') }}₫</p>
                        </div>
