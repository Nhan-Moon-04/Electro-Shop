        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div>
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="flex items-center border-2 border-gray-300 rounded-lg">
                                ...
                                <input type="number" value="1" min="1"
                                    class="quantity-input w-16 text-center py-2 focus:outline-none">
                                <button class="px-4 py-2 hover:bg-gray-100 transition">
                    ...
                    <!-- Action Buttons -->
                    <button class="add-to-cart-button flex-1 btn-primary py-4 text-lg" data-variant-id="123"> <i
                            class="fas fa-shopping-cart mr-2"></i>Thêm vào giỏ
                    </button>
    ...
    <div class="bg-white rounded-lg shadow-md mb-8" x-data="{ activeTab: 'description' }">
        ...
        <div class="p-6">
            ...
            <div x-show="activeTab === 'description'" class="prose max-w-none">
                ...
                <p class="mb-4">iPhone 15 Pro Max là chiếc smartphone cao cấp nhất trong dòng iPhone 15 Series của Apple.
                    Với thiết kế khung titanium sang trọng, chip A17 Pro mạnh mẽ và camera 48MP ấn tượng.</p>

                <h4 class="text-lg font-bold mb-2">Thiết kế đột phá với khung titanium</h4>
                <p class="mb-4">Lần đầu tiên Apple sử dụng chất liệu titanium cấp hàng không cho khung máy, mang lại độ bền
                    cao nhưng vẫn giữ được trọng lượng nhẹ.</p>

                <h4 class="text-lg font-bold mb-2">Hiệu năng đỉnh cao với chip A17 Pro</h4>
                <p class="mb-4">Chip A17 Pro được sản xuất trên tiến trình 3nm tiên tiến nhất, mang lại hiệu năng vượt trội
                    và tiết kiệm điện năng tối ưu.</p>

                <h4 class="text-lg font-bold mb-2">Camera chuyên nghiệp</h4>
                <p class="mb-4">Hệ thống camera sau 3 ống kính với cảm biến chính 48MP, hỗ trợ zoom quang học 5x và nhiều
                    tính năng chụp ảnh chuyên nghiệp.</p>
            </div>
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="flex space-x-2 mb-3">
                                        <img src="https://via.placeholder.com/100x100/FFFFFF/0066CC?text=Review" alt="Review"
                                    ...
                                    <div class="flex items-center space-x-4 text-sm text-gray-600">
                                        <button class="hover:text-primary transition"><i class="far fa-thumbs-up mr-1"></i>Hữu
                                            ích ({{ rand(5, 50) }})</button>
