...
<div class="w-full">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-600 text-sm mt-1">Điền thông tin nhà cung cấp</p>
        </div>
    ...
    <!-- Form -->
    <form action="{{ route('admin.suppliers.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-sm p-8">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="flex items-center">
                <input type="checkbox" name="supplier_is_display" id="supplier_is_display" class="w-6 h-6 text-blue-600" checked>
                <label for="supplier_is_display" class="ml-3 text-lg font-medium text-gray-700">Hiển thị nhà cung cấp</label>
            </div>

            <!-- Logo nhà cung cấp -->
            <div class="md:col-span-2">
                <label class="block text-lg font-medium text-gray-700 mb-3">Logo nhà cung cấp <span class="text-red-500">*</span></label>
